...
impl<'d> serde::ser::Serializer for ValueSerializer<'d> {
    type Ok = ();
    type Error = Error;
    type SerializeSeq = super::array::SerializeValueArray<'d>;
    type SerializeTuple = super::array::SerializeValueArray<'d>;
    type SerializeTupleStruct = super::array::SerializeValueArray<'d>;
    type SerializeTupleVariant = super::map::SerializeTupleVariant<'d>;
    type SerializeMap = super::map::SerializeMap<'d>;
    type SerializeStruct = super::map::SerializeMap<'d>;
    type SerializeStructVariant = super::map::SerializeStructVariant<'d>;
    ...
    fn serialize_seq(self, _len: Option<usize>) -> Result<Self::SerializeSeq, Self::Error> {
        super::array::SerializeValueArray::new(self.dst)
    }
    ...
    fn serialize_tuple_variant(
        ...
        super::map::SerializeTupleVariant::tuple(self.dst, variant, len)
    }

    fn serialize_map(self, _len: Option<usize>) -> Result<Self::SerializeMap, Self::Error> {
        super::map::SerializeMap::table(self.dst)
    }
    ...
    fn serialize_struct(
        ...
        if name == toml_datetime::__unstable::NAME {
            Ok(super::map::SerializeMap::datetime(self.dst))
        } else {
    ...
    fn serialize_struct_variant(
        ...
        super::map::SerializeStructVariant::struct_(self.dst, variant, len)
    }
}

...
mod key;
mod map;
#[allow(clippy::module_inception)] // for easy diffing
mod value;
...
impl<'d> serde::ser::Serializer for ValueSerializer<'d> {
    ...
    type SerializeTupleVariant = map::SerializeTupleVariant<'d>;
    type SerializeMap = map::SerializeMap<'d>;
    type SerializeStruct = map::SerializeMap<'d>;
    type SerializeStructVariant = map::SerializeStructVariant<'d>;
